...
class Menu extends Component {
                ...
                sub = (
                    <div
                        ...
                        onClick={(e) => {
                            ...
                            if (
                                e.target.classList.contains("menu-categories")
                            ) {
    ...
    handleExpanded(evt) {
        if (evt.target.classList.contains("menu__item--has-child")) {
            evt.target.setAttribute(
                "aria-expanded",
                !(evt.target.getAttribute("aria-expanded") == "true")
            )
        }
    }
    ...
    handleClick() {
        ...
        document
            .querySelector(".button__menu")
            .classList.remove("button__menu--close")
    }
        ...
        if (this.props.hasErrored) {
            return (
                <div
                    ...
                    class={this.state.mobile ? "menu--mobile" : "menu--desktop"}
                    role="menubar"
                >
                    OPS!! Ocorreu algum erro no Carregamento . . .
                </div>
            )
        }
        ...
        if (this.props.isLoading) {
            return (
                <div
                    aria-expanded={this.props.expanded}
                    className={
                        this.state.mobile ? "menu--mobile" : "menu--desktop"
                    }
                    role="menubar"
                >
                                    ...
                                    <div className="menu__user">
                                        <ul className="menu__user-list">
                                            <li className="menu__user-list-item">
                                                <a
                                                    className="menu__user-list-link menu__user-list-link--user"
                                                    href="/account"
                                                >
                                                    Minha Conta
                                                </a>
                                            ...
                                            <li className="menu__user-list-item">
                                                <a
                                                    className="menu__user-list-link menu__user-list-link--orders"
                                                    href="/account/orders"
                                                >
                                                    Pedidos
                                                </a>
                                            ...
                                            <li className="menu__user-list-item">
                                                <a
                                                    className="menu__user-list-link menu__user-list-link--mail"
                                                    href="/contato"
                                                >
                                                    Contato
                                                </a>
                                            ...
                                            <li className="menu__user-list-item">
                                                <a
                                                    className="menu__user-list-link menu__user-list-link--help"
                                                    href="/institucional/ajuda"
                                                >
                                                    Ajuda
                                                </a>
                                            </li>
